...
<body>
  ...
  <div class="privacyPolicy">
    ...
    <h1 class="headline">隱私權政策</h1>
    <div class="introText">
      <p class="introText">
        非常歡迎您光臨πChill（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
        πChill網站管理系統是一個具線上預約功能之內部營運系統。
        本系統除供各營業人進行自有會員經營與內部管理外，
        各營業人亦可透過與πChill網站後台之設定，供自有客戶進行服務之線上預約，同時透過平台獲得行銷導客的成果。
        消費者經由πChill平台，除能透過各營業人由後台指派方案而獲得線上預約權限外，亦得直接查找各場館累積之作品、評價，
        找到自己喜愛的店家進行線上預約後消費。
        為了保障您使用本系統的權益，請您務必詳閱下列服務條款，當您完成本網站註冊時並登入，即視為已知悉、並且同意本服務條款的所有約定：</p>
    </div>
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-push-1">
          ...
          <ol class="termList">
            ...
            <li class="termList">四、網站對外的相關連結
              <ol class="sub">
                <li>本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。
              </ol>
            </li>
            <li class="termList">五、與第三人共用個人資料之政策
              <p>
...
前項但書之情形包括不限於：
            ...
            <li class="termList">六、Cookie 之使用
              <ol class="sub">
                <li>為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的 Cookie，若您不願接受 Cookie 的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕 Cookie 的寫入，但可能會導致網站某些功能無法正常執行 。
              </ol>
            </li>
            <li class="termList">七、隱私權保護政策之修正
              <p>本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。</p>
            </li>
            <li class="termList">八、特別授權事項
              <p>
