...
<head>
  ...
  <link rel="stylesheet" href="../../bootstrap1/bootstrap-5.3.2-dist/css1.css/css.css">
    ...
    <div class="container">
      <header class="d-flex flex-wrap justify-content-center py-1">
        ...
        <ul class="nav nav-pills">
          ...
          <li class="nav-item"><a href="../../announcement/announcement.html" class="nav-link">公告</a></li>
    ...
    <div class="container">
      <header class="d-flex flex-wrap justify-content-center py-3">
        ...
        <ul class="nav nav-pillss">
          ...
          <li class="nav-item"><a href="../disclaimer/disclaimer.html" class="nav-link">免責條款</a></li>
        </ul>
      </header>
    </div>
  </footer>
