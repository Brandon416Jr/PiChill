...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/owneruser/CSS/css.css">
<link rel="stylesheet"
	...
	<div class="main_content">
		...
		<main class="main">
			...
			<c:if test="${not empty errorMsgs}">
				...
				<span>企業會員編號:</span> <input type="text" id="oUserID" name="oUserID"
					value="<%=ownerUser.getoUserID()%>" disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>帳號:</span> <input type="text"
					id="oUserName" name="oUserName" style="width: 250px;"
					value="<%=(ownerUser == null) ? "yehshaa0106" : ownerUser.getoUserName()%>"
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>密碼:</span> <input type="text"
					id="oPassword" name="oPassword"
					value="<%=(ownerUser == null) ? "LtaS845r" : ownerUser.getoPassword()%>"
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>統編:</span> <input type="text"
					id="compiled" style="position: relative; left: 17px;"
					name="compiled"
					value="<%=(ownerUser == null) ? "09071688" : ownerUser.getcompiled()%> "
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>場館負責人姓名:</span> <input
					type="text" id="oName" name="oName"
					value="<%=(ownerUser == null) ? "葉夢華" : ownerUser.getoName()%>"
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>性別:</span> <input type="text"
					id="oGender" name="oGender"
					value="<%=(ownerUser == null) ? 0 : ownerUser.getoGender()%>"
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>場館負責人身分證字號:</span> <input
					type="text" id="oIDNum" name="oIDNum"
					value="<%=(ownerUser == null) ? "H212810987" : ownerUser.getoIDNum()%>"
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>出生年月日:</span> <input
					type="text" id="oBirth" name="oBirth"
					value="<%=(ownerUser == null) ? "1990-01-06" : ownerUser.getoBirth()%>"
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20px" height="20"> <span>連絡電話:</span> <input
					type="text" id="oTelephone" name="oTelephone"
					value="<%=(ownerUser == null) ? "0934862754" : ownerUser.getoTelephone()%>"
					disabled /> <font color="#FF0000" size="-1">如:0912345678。</font> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>聯絡地址:</span> <input type="text"
					id="oAddress" style="width: 250px;" name="oAddress"
					placeholder="請輸入聯絡地址"
					value="<%=(ownerUser == null) ? "新北市新店區民權路98號6樓" : ownerUser.getoAddress()%>"
					disabled /> <br>
				<br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20"> <span>銀行代號：</span> <input type="text"
					id="oBankCode" name="oBankCode"
					value="<%=(ownerUser == null) ? "808" : ownerUser.getoBankCode()%>"
					placeholder="如:012" disabled> <br> <br> <img
					src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20" alt=""> <span>銀行帳號：</span> <input
					type="text" id="bank_account" name="oBankAccount"
					value="${ownerUser.oBankAccount}" disabled> <br> <br>


				<img src="<%=request.getContextPath()%>/owneruser/pic/stR01.png"
					width="20" height="20" alt=""> <span>電子信箱：</span> <input
					type="text" id="oEmail" name="oEmail" style="width: 250px;"
					value="<%=(ownerUser == null) ? "yehshaa0106@gmail.com" : ownerUser.getoEmail()%>"
			...
			<FORM METHOD="post"
				...
				<input type="submit" id="next" value="我要修改"
					style="width: 150px; height: 44px;"> <br>
				<br>
				<br> <br>
				<br>
			</FORM>
