...
<title>員工資料新增 - addManage.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>員工資料新增 - addManage.jsp</h3></td><td>
...
<table>
	...
	<tr>
		<td>帳號:</td>
		<td><input type="TEXT" name="mUserName"   value="<%= (manage==null)? "Chen5252" : manage.getmUserName()%>" size="45"/></td>
	</tr>
	<tr>
		<td>密碼:</td>
		<td><input type="password" name="mPassword" value="<%= (manage==null)? "52552252" : manage.getmPassword()%>" size="45"/></td>
	</tr>
	<tr>
		<td>生日:</td>
	...
	<tr>
		<td>身份證:</td>
		<td><input type="TEXT" name="mID" value="<%= (manage==null)? "A123456678" : manage.getmID()%>" size="45"/></td>
	</tr>
	<tr>
		<td>電子信箱:</td>
