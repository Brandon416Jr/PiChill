...
<%@ page import="com.pichill.generaluser.model.GeneralUserDAO"%>
<%@ page import="com.pichill.backstage.generaluser.model.GeneralUserDAOImplBack"%>
        ...
        <div class="container-fluid">
          <ul class="navbar-mobile__list list-unstyled">
            ...
            <li class="has-sub">
              ...
              <ul class="list-styled navbar__sub-list js-sub-list">
                <li>
                  <a class="active" href="#">所有會員資料</a>
                </li>
                <li>
                  <a href="set_gUser.html">新增會員資料</a>
                </li>
              </ul>
            </li>
            <li class="has-sub">
              ...
              <ul class="list-styled navbar__sub-list js-sub-list">
                ...
                <li>
                  <a href="set_oUser.html">新增會員資料</a>
                </li>
              </ul>
            </li>
            <li class="has-sub">
      ...
      <table id="myTable" class="table table-borderless table-data3" style="overflow-x: auto" hover>
        ...
        <c:forEach var="generalUser" items="${list}">
          <tr>
            ...
            <td>${generalUser.gPostAmount}</td>
            <td>${generalUser.commentAmount}</td>
            <td>${generalUser.gReportCnt}</td>
