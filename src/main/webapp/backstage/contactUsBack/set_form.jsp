					...
					<ul class="list-unstyled navbar__list expanded">
						...
						<li class="has-sub"><a class="js-arrow" href="#"> <i
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								...
								<li><a
									href="<%=request.getContextPath()%>/backstage/reportBack/report.jsp">檢舉管理</a></li>
							</ul></li>
						<li class="has-sub"><a class="js-arrow" href="#"> <i
			...
			<div class="container-fluid2">
				<div class="card">
					<div class="card-header">
						...
						<h4>
							<a
								href="<%=request.getContextPath()%>/backstage/contactUsBack/all_form.jsp"><img
								...
								<div class="card-body card-block">
									<form
										...
										<div class="row form-group">
											...
											<div class="col-10 col-md-8">
												<input type="file" id="file-input" name="formPic"
