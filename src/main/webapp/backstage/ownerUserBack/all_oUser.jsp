...
<%@ page import="com.pichill.backstage.owneruser.service.OwnerUserServiceBack"%>
<%-- 此頁練習採用 EL 的寫法取值 --%>
              ...
              <div class="header-logo">
                <a href="index.html"
                  ><img
                    class="img-logo"
                    href="index.html"
                    src="<%=request.getContextPath()%>/image/bigLogo.png"
                    alt=""
                /></a>
              </div>
        ...
        >
          ...
          <c:forEach var="manage" items="${list}">
            <tr>
              ...
              <td>${ownerUser.bankCode}</td>
              <td>${ownerUser.bankAccount}</td>
