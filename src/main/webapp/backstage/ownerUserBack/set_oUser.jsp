...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/backEnd-Website/css/set.css" />
  <style></style>
</head>
          ...
          <ul class="navbar-mobile__list list-unstyled">
            ...
            <li class="has-sub">
              ...
              <ul class="list-styled navbar__sub-list js-sub-list">
                ...
                <li>
                  <a href="new_announce.html">新增公告</a>
                </li>
              </ul>
            </li>
            <li class="has-sub">
                  ...
                  <div class="left-card-body card-block">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="disabled-input" name="oUserID" value="<%=ownerUser.getoUserID()%>" disabled="disabled"
                             class="form-control" />
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oUserName" value="<%=ownerUser.getoUserID()%>" disabled="disabled"
                            class="form-control" />
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oPassword" value="<%=ownerUser.getoPassword()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oIDNum" value="<%=ownerUser.getoIDNum()%>" disabled="disabled"
                            class="form-control"/>
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                       <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="compiled" value="<%=ownerUser.getCompiled()%>" disabled="disabled"
                            class="form-control"/>
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="disabled-input" name="oName" value="<%=ownerUser.getoName()%>" disabled="disabled"
                            class="form-control" />
                        </div>
                      </div>
                      <div class="row form-group">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oBirth" value="<%=ownerUser.getoBirth()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oTelephone" value="<%=ownerUser.getoTelephone()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oAddress" value="<%=ownerUser.getoAddress()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="bankCode" value="<%=ownerUser.getoAddress()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                ...
                <div class="col-lg-6">
                  <div class="right-card-body card-block">
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="bankAccount" value="<%=ownerUser.getoAddress()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oRegisterDate" value="<%=ownerUser.getoRegisterDate()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input"  name="oPostAmount" value="<%=ownerUser.getoPostAmount()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input"  name="oReportCnt" value="<%=ownerUser.getoReportCnt()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input"  name="courtArriveCnt" value="<%=ownerUser.getCourtArriveCnt()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="rsvdCnts" value="<%=ownerUser.getRsvdCnts()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-10 col-md-8">
                          <input type="text" id="text-input" name="oEmail" value="<%=ownerUser.getoEmail()%>" disabled="disabled"
                            class="form-control" />
                          <!-- <small class="form-text text-muted">This is a help text</small> -->
                        </div>
                      </div>
