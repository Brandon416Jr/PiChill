...
<%@ page import="com.pichill.backstage.court.model.CourtDAOImplBack"%>
<%@ page import="com.pichill.backstage.court.service.CourtServiceBack"%>
...
<link rel="stylesheet"
	...
	media="all" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/backEnd-Website/css/court.css"
	media="all" />
	<link rel="stylesheet"
...
<!-- 												<span class="email">brandon416jr@gmail.com</span> -->
	...
	<div class="page-container2">
		...
		<div class="excel">
					<form action="<%=request.getContextPath()%>/exportexcelcourt"
						method="post">
						<button class="excel">下載</button>
					</form>
				</div>
				...
				<tbody>
					<c:forEach var="court" items="${list}">
						<tr>
							...
							<td><FORM METHOD="post"
									ACTION="<%=request.getContextPath()%>/court/courtb.do"
