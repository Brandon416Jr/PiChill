...
List<Court> list = courtSvcB.getAll();
...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/backEnd-Website/css/court.css" media="all" />
  <style>
          ...
          <ul class="list-unstyled navbar__list expanded">
            <li class="has-sub">
              ...
              <ul class="list-unstyled navbar__sub-list js-sub-list">
                <li>
                  <a class="active" href="<%=request.getContextPath()%>/backstage/manage/all_manage.jsp">所有員工資料</a>
                </li>
                <li>
                  <a href="<%=request.getContextPath()%>/backstage/manage/new_manage.jsp">新增員工資料</a>
                </li>
              </ul>
            </li>
            <li class="has-sub">
        ...
        <c:forEach var="court" items="${list}">
          <tr>
            ...
            <td>
              ...
              5.禁止隨行兒童於場地內奔跑嬉戲。 6.凡私人物品應自行保管。
              7.排球網不可調整，如擅自調整造成設備/耗材損壞，租借人須照價賠償。
              8.備有洗手間、製冰機(僅供冰敷)及飲水機。
              9.租借單位須於租借時段內完成進退場，時間屆止，租借單位須立即離場
              10.本場館亦開放包場辦理比賽、夏令營、冬令營等活動，費用另計，請洽本場地人員。
            </td>
            <td>新北市</td>
            <td>2</td>
            <td>
              <i><a href="set_court.html">查看</a></i>
            </td>
          </tr>
          </c:forEach>
        </tbody>
