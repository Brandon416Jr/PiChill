...
<%@ page import="com.pichill.backstage.announcement.service.AnnouncementServiceBack"%>
<%-- 此頁練習採用 EL 的寫法取值 --%>
...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/backEnd-Website/css/announce.css" media="all" />
  <style>
...
<body class="animsition all-employees-page">
        ...
        <div class="container-fluid">
          <ul class="navbar-mobile__list list-unstyled">
            ...
            <li class="has-sub">
              ...
              <ul class="list-styled navbar__sub-list js-sub-list">
                <li>
                  <a class="active" href="all_gUser.html">所有會員資料</a>
                </li>
                <li>
          ...
          <ul class="list-unstyled navbar__list expanded">
            <li class="has-sub">
              ...
              <ul class="list-unstyled navbar__sub-list js-sub-list">
                <li>
                  <a class="active" href="all_manage.html">所有員工資料</a>
                </li>
                <li>
                  <a href="new_manage.html">新增員工資料</a>
                </li>
        ...
        <div class="container-fluid">
          <div class="header-wrap">
            <div class="header-logo">
              <a href="index.html"><img class="img-logo" href="index.html" src="./pic/pi_chill_text.png" alt="" /></a>
            </div>
            ...
            <div class="header-button">
              <div class="account-wrap">
                <div class="account-item clearfix js-item-menu">
                  <div class="image">
                    <img src="./pic/Group 115.png" alt="使用者頭像" />
                  </div>
                  <div class="content">
                  ...
                  <div class="account-dropdown js-dropdown">
                    <div class="info clearfix">
                      <div class="image">
                        <a href="#">
                          <img src="./pic/Group 115.png" alt="John Doe" />
                        </a>
                      </div>
                      <div class="content">
                        <h5 class="name">
  ...
  <div class="page-container2">
    <div class="table-responsive m-b-40">
      <table id="myTable" class="table table-borderless table-data3" style="overflow-x: auto" hover>
        <thead>
          <tr>
            <th>公告編號</th>
            <th>管理員員編號</th>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              commodi excepturi, quam temporibus ullam debitis? Corrupti
              perferendis atque, illum nesciunt, sint vero voluptas numquam
              ratione et iste optio. Quo, nihil.Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Ipsa commodi excepturi, quam
              temporibus ullam debitis? Corrupti perferendis atque, illum
              nesciunt, sint vero voluptas numquam ratione et iste optio. Quo,
              nihil.
            </td>
            <td>lefrler.jpg</td>
            <td>2023-08-24 21:44:54</td>
            <td>1</td>
            <td>
              <i><a href="set_announce.html">查看</a></i>
            </td>
          </tr>
        </tbody>
      </table>
