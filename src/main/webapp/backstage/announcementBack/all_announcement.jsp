...
<link rel="stylesheet"
	...
	media="all" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/backEnd-Website/css/announce.css"
	media="all" />
<style>
				...
				<div class="container-fluid">
					<ul class="navbar-mobile__list list-unstyled">
						...
						<li class="has-sub"><a class="js-arrow" href="#"> <i
							...
							<ul class="list-styled navbar__sub-list js-sub-list">
								<li><a class="active" href="all_gUser.html">所有會員資料</a></li>
					...
					<ul class="list-unstyled navbar__list expanded">
						<li class="has-sub"><a class="js-arrow" href="#"> <i
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								<li><a class="active" href="all_manage.html">所有員工資料</a></li>
								<li><a href="new_manage.html">新增員工資料</a></li>
							</ul></li>
						<li class="has-sub"><a class="js-arrow" href="#"> <i
								class="fas fa-tachometer-alt"></i>一般會員管理
				...
				<tbody>
					<c:forEach var="announcement" items="${list}">
						<tr>
							...
							<td>${announcement.annoStatus}</td>
							<td><FORM METHOD="post"
									ACTION="<%=request.getContextPath()%>/announcement/announcementb.do"
									...
									<input type="hidden" name="announceID" value="${announcement.announceID}">
