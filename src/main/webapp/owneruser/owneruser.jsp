		...
		<div class="container">
			<header class="d-flex flex-wrap justify-content-center py-1">
				...
				<ul class="nav nav-pills">
					...
					<img src="<%=request.getContextPath()%>/owneruser/pic/face.svg" alt="企業會員頭像" />會員中心</a></li>
				</ul>
			</header>
		</div>
	</header>
...
<!----------------------------------------------- aside 區 ------------------------------------------------------->
    ...
    <main class="main">
		...
		<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/owneruser/owneruser.do" enctype="multipart/form-data" class="bararea">
                ...
                <img src="<%=request.getContextPath()%>/owneruser/pic/stR01.png" width="20" height="20"> 
                <span>統編:</span>
                <input type="text" id="compiled" name="compiled" value="<%= (ownerUser == null) ? "09071688" : ownerUser.getcompiled()%> style="position: relative; left: 17px;" required"/>
                <br><br>
...
<%--            <input type="text" id="oGender" name="oGender" value="<%= (ownerUser==null)? 1 : ownerUser.getoGender()%>"/> --%>
                ...
                <img src="<%=request.getContextPath()%>/owneruser/pic/stR01.png" width="20" height="20">    
                <span>聯絡地址:</span>
                 <input type="text" id="oAddress" name="oAddress" placeholder="請輸入聯絡地址" 
               ...
               <br>  
                ...
                <span>大頭貼:</span><br>
                <div id="blob_holder">
                <img src="<%=request.getContextPath()%>/owneruser/DBGifReader?oUserID=${param.oUserID}" width="100px"></div>
                <input type="file" id="oProfilePic" name="oProfilePic" onclick="previewImage()" multiple="multiple" />
                <br>
                <input type="hidden" name="action" value="update">
				<input type="hidden" name="gUserID" value="<%=ownerUser.getoUserID()%>">
