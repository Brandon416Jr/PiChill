...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="post.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		<td>文章標題:</td>
		<td><input type="TEXT" name="postTitle" value="<%= (post==null)? "我是標題" : post.getPostTitle()%>" size="45"/></td>
	</tr>
	<tr>
		<td>內文:</td>
		<td><input type="TEXT" name="postContent"   value="<%= (post==null)?  "我是內文" : post.getPostContent()%>"  size="45"/></td>
	</tr>
	<tr>
...
<%--           <option value="${post.postType}">${post.postType} --%>
                    ...
                    <option value = "1">揪團</option>
                    <option value = "2">推撥</option>
