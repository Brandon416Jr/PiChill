				...
				<div class="login-wrap">
					<div class="login-content">
						...
						<div class="login-form">
							<form action="<%=request.getContextPath()%>/gloginhandler"
								method="post">
								...
								<div class="form-group">
									...
									<input class="au-input au-input--full" type="text"
										name="checkCode" placeholder="請輸入驗證碼" /> <img id="yzm_img"
										src="${pageContext.request.contextPath}/valistr"
								...
								<button class="au-btn au-btn--block au-btn--green m-b-20"
									...
									<div  class="error-message" style="color: red;">${requestScope.errorMsgs.status}</div>
							</form>
							<div class="register-link">
								...
								<p>
									不想登入，以<a
										href="${pageContext.request.contextPath }/homepage/main.jsp">訪客</a>身分進入網站
								</p>
							</div>
						</div>
					</div>
