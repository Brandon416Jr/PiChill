        ...
        <div class="login-wrap">
          <div class="login-content">
            ...
            <div class="login-form">
              <form action="<%=request.getContextPath()%>/gloginhandler" method="post">
                <div class="form-group">
                  <label>使用者帳號</label><font color=red>${requestScope.errorMsgs.gUsername}</font>
                  <input class="au-input au-input--full" type="text" name="gUsername" placeholder="請輸入帳號" value="${param.gUsername}" />
                </div>
                <div class="form-group">
                  <label>密碼</label><font color=red>${requestScope.errorMsgs.gPassword}</font>
                  <input class="au-input au-input--full" type="password" id="password" name="gPassword" value="${param.gPassword}" placeholder="請輸入密碼" />
                  <div class="pwd-see">
                ...
                <div class="login-checkbox">
                  ...
                  <label>
                    <a href="${pageContext.request.contextPath }/login/gLogin/gUserForgotPwd.jsp">忘記密碼?</a>
                  </label>
                </div>
