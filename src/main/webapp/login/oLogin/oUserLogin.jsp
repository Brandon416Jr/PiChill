				...
				<div class="login-wrap">
					<div class="login-content">
						<div class="login-logo">
							<a href="#"> <img
								src="<%=request.getContextPath()%>/backEnd-Website/pic/o_login1.png"
								alt="CoolAdmin" />
							</a>
						</div>
						<div class="login-form">
							<form action="<%=request.getContextPath()%>/ologinhandler"
								method="post" id="loginForm">
								<div class="form-group">
									<label>帳號</label><font color=red>${requestScope.errorMsgs.oUserName}</font>
									<input class="au-input au-input--full" type="text"
										name="oUserName" placeholder="請輸入帳號"
										value="${param.oUserName}" />
								</div>
								<div class="form-group">
									<label>密碼</label><font color=red>${requestScope.errorMsgs.oPassword}</font>
									<input class="au-input au-input--full" type="password"
										id="password" name="oPassword" placeholder="請輸入密碼" />
									<div class="pwd-see">
							...
							<div class="register-link">
								<p>
									你尚未有帳號? <a
										href="${pageContext.request.contextPath }/login/oLogin/oUserRegist.jsp">我要註冊</a>
								</p>
							</div>
						</div>
					</div>
