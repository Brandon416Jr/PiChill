...
<!-- 							</div> -->
							...
							<div class="register-link">
								<p>
									已經有帳號了嗎? <a href="${pageContext.request.contextPath }/frontstage/ownerUserFront/oUserLogin.jsp">登入</a>
								</p>
							</div>
						</div>
					</div>
	...
	try {
		oRegistDate = java.sql.Date.valueOf(request.getParameter("gRegistDate").trim());
	} catch (Exception e) {
