		...
		<main class="main">
			...
			<form class="bararea" enctype="multipart/form-data">
				<label for="reserveDate">預約日期:</label> <input type="date"
					id="reserveDate" name="reserveDate"><br>
				<br> <label for="reserveOrderID">預約訂單編號:</label> <input
					type="text" id="reserveOrderID" name="reserveOrderID">
			</form>
			<div></div>
			<div></div>
			<div></div>
			<div class="container" id="datatable">
				<table id="table_id" class="display hover cell-border stripe responsive nowrap">
					<thead>
						<!-- 欄位名稱 -->
						<tr>
							<th>預約訂單編號</th>
...
<!-- 							<td> -->
<!-- 								<FORM METHOD="post" -->
<%-- 									ACTION="<%=request.getContextPath()%>/reserveorder/reserveorder.do" --%>
<!-- 									style="margin-bottom: 0px;"> -->
<!-- 									<input type="submit" value="取消"> <input type="hidden" -->
<%-- 										name="reserveOrderID" value="${reserveOrder.reserveOrder}"> <input --%>
