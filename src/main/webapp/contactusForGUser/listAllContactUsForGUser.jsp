...
<title>listAllContactUsGUser</title>
<!-- JQuery 連結 -->
<script
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/generaluser/css2/index.css">
</head>
<body>
<!----------------------------------------------- header 區 ------------------------------------------------------->
	<header class="header">
			...
			<header class="d-flex flex-wrap justify-content-center py-1">
				...
				<ul class="nav nav-pills">
					...
					<li class="nav-item"><a href="<%=request.getContextPath()%>/generaluser/guserListOne.jsp"
						...
						alt="<%=request.getContextPath()%>/NoData/defaultpic.png" class="rounded-circle" /> 會員中心</a></li>
				</ul>
