...
//		System.out.print(res2.getCouponID() + ",");
...
//		// 查詢多筆
		...
		for (ReserveOrder res3 : list) {
			...
			System.out.print(res3.getCouponID() + ",");
