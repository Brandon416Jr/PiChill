...
public class OwnerUserServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		case "getOne_For_Update":
			...
			break;
		case "update":
			// 來自update_OwnerUser_input.jsp的請求
	...
	private String getOneUpdate(HttpServletRequest req, HttpServletResponse res) {
		Integer gUserID = Integer.valueOf(req.getParameter("oUserID"));

		OwnerUser ownerUser = ownerUserService.getOneOwnerUser(oUserID);

		req.setAttribute("ownerUser", ownerUser);
		return "/owneruser/update_OwnerUser_input.jsp";
	}
	...
	private String update(HttpServletRequest req, HttpServletResponse res) {
		...
		if (oIDNum == null || compRegex.trim().isEmpty()) {
...
//		ownerUser.setoProfilePic(oProfilePic);
		...
		ownerUser.setourtArriveCnt(courtArriveCnt);
		...
		if (!errorMsgs.isEmpty()) {
			...
			return "/owneruser/update_OwnerUser_input.jsp"; // 程式中斷
		}
		/*************************** 2.開始修改資料 *****************************************/
