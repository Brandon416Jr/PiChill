...
primary key(timeID));
>>>>>>> db7f6f8157b167063171ef29aec5b5569016c3d6
...
INSERT INTO court (oUserID, manageID, courtOnTime, courtApplyTime, courtName, courtPic, courtTelephone, courtAddress, courtRule, loc, courtApplyStatus)
VALUES
...
本須知如有未盡事宜，得另行增列、修訂之，並以現場公告或服務人員說明為準。','大安區', 0),
...
10.本場館亦開放包場辦理比賽、夏令營、冬令營等活動，費用另計，請洽本場地人員。','022749049','臺北市中正區大崙街11號1樓','','中正區', 0),
...
11.羽球架應由場館人員操作，未經許可請勿擅自操作使用，以防止危險發生或機器損壞。','大同區', 0),
...
◾本須知如有未盡事宜，得另行增列、修訂之，並以現場公告或工作人員說明為準。若未能配合管理者，現場工作人員將有權令其離場，以維護其他使用者的安全。','北投區', 0),
...
本規範如有未盡事宜，本館得隨時修正之，經場長核定並報府備查後公告實施。','萬華區', 0),
...
（七） 如有違反上述規定，本所得禁止其使用並言詞勸導，若不服勸導者，必要時請警察機關協助處理。','中山區', 0),
...
6.未經許可禁止張貼海報、旗幟、標語等。
7.未經申請核准者，不得進行私人教學。
8.違反本規範經勸導仍不改善，本場得立即中止使用權利並令其離場，不得異議，並不得要求退還已繳之費用','信義區', 0),
